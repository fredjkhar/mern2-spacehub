    ...
    <div id='body'> 
      <div className='row'>
        ...
        <div className='topic-text col-xs-12 col-lg-6' >
            ...
            {t('article_1_text_1')}&nbsp;
            <Link to='/article' onClick={() => {setArticles(1)}}>{t('read_more')}</Link>
            </div>
        </div>
        <hr/>
        ...
        <div className='topic-text col-xs-12 col-lg-6'>
            <div className='text' style={{fontSize: '1.3rem'}}>
            {t('article_2_text_1')}&nbsp;
            <Link to='/article' onClick={() => {setArticles(2)}} >{t('read_more')}</Link>
            </div>
        </div>
        <hr/>
        ...
        <div className='topic-text col-xs-12 col-lg-6'>
            <div className='text' style={{fontSize: '1.3rem'}}>
            {t('article_3_text_1')}&nbsp;
            <Link to='/article' onClick={() => {setArticles(3)}}>{t('read_more')}</Link>
            </div>
        </div>
        <hr/>
